/**
 * Proxy serverless — Jupiter /tokens/v2/search
 * Roda no servidor Vercel, mantém JUPITER_API_KEY fora do browser.
 * Variável de ambiente necessária: JUPITER_API_KEY
 */
